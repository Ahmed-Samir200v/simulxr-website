...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0A1E36] border-t border-white/5 pt-20 pb-8">
      <div className="container">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-white/40 text-sm mt-6 max-w-md mx-auto">
            {t(
              "Immersive XR training for industrial safety. Arabic-first, facility-specific, outcome-driven.",
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/50">
              <li><Link href="/services" className="hover:text-[#D4622B] transition-colors">{t("Services", "خدماتنا")}</Link></li>
              <li><Link href="/industries" className="hover:text-[#D4622B] transition-colors">{t("Industries", "القطاعات")}</Link></li>
              <li><Link href="/case-studies" className="hover:text-[#D4622B] transition-colors">{t("Case Studies", "دراسات الحالة")}</Link></li>
              <li><Link href="/insights" className="hover:text-[#D4622B] transition-colors">{t("Insights", "المقالات")}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/50">
              <li><Link href="/about" className="hover:text-[#D4622B] transition-colors">{t("About", "من نحن")}</Link></li>
              <li><Link href="/contact" className="hover:text-[#D4622B] transition-colors">{t("Contact", "تواصل معنا")}</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-white/50">
              ...
              <div className="flex items-center gap-3 mt-4">
                <a href="#" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:border-[#D4622B] hover:text-[#D4622B] transition-colors" aria-label="Twitter">
                ...
                <a href="#" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:border-[#D4622B] hover:text-[#D4622B] transition-colors" aria-label="LinkedIn">
